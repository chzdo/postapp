...
if($email == false){
 ...
 if($app->getReferee()==false){
    echo sendJson(array('code' => 0, 'message' => "Referee not found", 'payload' => []));
    return;
 }
 
  echo sendJson(array("code"=>1 , "message"=>"Referee Found","payload"=>$app->referee));
  return;
} catch (Exception $e) {
