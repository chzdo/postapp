...
if($email == false){
 ...
 if($app->getOther()==false){
    echo sendJson(array('code' => 0, 'message' => "Other information not found", 'payload' => []));
    return;
 }
 
  echo sendJson(array("code"=>1 , "message"=>"Other Information Found","payload"=>$app->other));
  return;
} catch (Exception $e) {
