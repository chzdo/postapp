...
if($email == false){
 ...
 if($app->getProf()==false){
    echo sendJson(array('code' => 0, 'message' => "Profesional information not found", 'payload' => []));
    return;
 }
 
  echo sendJson(array("code"=>1 , "message"=>"Profesional information  Found","payload"=>$app->prof));
  return;
} catch (Exception $e) {
