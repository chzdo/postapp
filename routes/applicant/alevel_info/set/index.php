...
if($email == false){
 ...
 $b = $app->setAlevel($postdata);
   ...
   $b = $app->getSummary();
  echo sendJson(array("code"=>1 , "message"=>"Alevel Found","payload"=>['alevel'=>$app->alevel, 'summary'=>array("side"=>$a,"main"=>$b)]));
  return;
} catch (Exception $e) {
