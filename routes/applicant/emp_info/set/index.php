...
if($email == false){
 ...
 $b = $app->setEmp($postdata);
   ...
   $b = $app->getSummary();
  echo sendJson(array("code"=>1 , "message"=>"Employment  Found","payload"=>['emp'=>$app->emp, 'summary'=>array("side"=>$a,"main"=>$b)]));
  return;
} catch (Exception $e) {
